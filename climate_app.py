...
#Return the JSON representation of a dictionary for dates as the key and precipitation as the value
...
def tobs():
    ...
    # Query to find the most active station within the last year 
    #(active station from 2016-08-23 to 2017-08-23: USC00519397)
    ...
    # Query for the temperature observations (TOBS) for the previous year 
    #Query for the previous year date from the last date of the last year above for temperature observations 
    #(previous year date: 2015-08-24)
    previous_year = dt.date(2016,8, 23) - dt.timedelta(days=365)

    #Query the dates of the most active station from last year for the previous year temperature observations 
    #(date range: 2015-08-24 to 2016-08-23 for station USC00519397)
    observations_1516 = session.query(Measurement.date, Measurement.tobs).\
    ...
    # Convert list of tuples into normal list
    dates_tobs_1516 = list(np.ravel(observations_1516))

    #Return a list of all dates and temperature observations from previous year(2015-08-24 to 2016-08-23) for station USC00519397
    return jsonify(dates_tobs_1516)
